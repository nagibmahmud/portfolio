...
async function initializeContent() {
    ...
    if (fileContent) {
        // Content loaded from file, update localStorage
        if (fileContent.hero) localStorage.setItem('portfolioHero', JSON.stringify(fileContent.hero));
        if (fileContent.projects) localStorage.setItem('portfolioProjects', JSON.stringify(fileContent.projects));
        if (fileContent.websites) localStorage.setItem('portfolioWebsites', JSON.stringify(fileContent.websites));
        if (fileContent.about) localStorage.setItem('portfolioAbout', JSON.stringify(fileContent.about));
        if (fileContent.skills) localStorage.setItem('portfolioSkills', JSON.stringify(fileContent.skills));
        if (fileContent.contact) localStorage.setItem('portfolioContact', JSON.stringify(fileContent.contact));
    }
}
